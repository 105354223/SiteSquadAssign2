...
echo "<div class='hrSection'>";
echo "<h3>Search by Job Reference:</h3>";
echo "<form method='GET' class='hrForm'>";
echo "<div class='hrFormGroup'>";
echo "<input type='text' name='job_ref' placeholder='Enter job reference' class='hrInput'>";
echo "</div>";
echo "<button type='submit' class='hrButton'>Search</button>";
echo "</form>";
echo "</div>";
...
echo "<input type='text' name='first_name' placeholder='Enter first name' class='hrInput'>";
echo "</div>";
echo "<button type='submit' class='hrButton'>Search</button>";
echo "</form>";
echo "</div>";
...
echo "<form method='GET' class='hrForm'>";
echo "<div class='hrFormGroup'>";
echo "<input type='text' name='lastName' placeholder='Enter last name' class='hrInput'>";
echo "</div>";
echo "<button type='submit' class='hrButton'>Search</button>";
echo "</form>";
echo "</div>";
...
echo "<form method='GET' class='hrForm'>";
echo "<div class='hrFormGroup'>";
echo "<select name='sort' class='hrSelect'>";
...
echo "</select>";
echo "</div>";
echo "<button type='submit' class='hrButton'>Sort</button>";
echo "</form>";
echo "</div>";
...
echo "<form method='POST' class='hrForm'>";
echo "<div class='hrFormGroup'>";
echo "<input type='text' name='job_reference' placeholder='Job reference' class='hrInput'>";
echo "</div>";
echo "<button type='submit' name='delete_by_jobref' class='hrButton delete'>Delete All</button>";
echo "</form>";
echo "</div>";
...
echo "<div class='hrTableContainer'>";
echo "<table class='hrTable'>";
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo "<td>";
    echo "<form method='POST' class='statusForm'>";
    echo "<input type='hidden' name='eoi_number' value='".$row['eoi_number']."'>";
    echo "<select name='new_status' class='statusSelect'>";
    echo "<option value='New'>New</option>";
    echo "<option value='Current'>Current</option>";
    echo "<option value='Final'>Final</option>";
    echo "</select>";
    echo "<button type='submit' name='update_status' class='statusUpdateBtn'>Update</button>";
    echo "</form>";
    echo "</td>";
    echo "</tr>";
}
...
echo "<div class='hrBavigation'>";
echo "<h3>Management Options:</h3>";
echo "<a href='login.php' class='hrLink'>Login Page</a><br>";
